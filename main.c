...
int main ( void )
{
    ...
    struct klingon_word * start_point_17 = & segment_10 [ 0 ];
    ...
    struct klingon_granularity ring_21 = { 1, "would", NULL, NULL, subject_1, segment_11, 1, 1 };
    ...
    struct klingon_word * start_point_22 = & segment_12 [ 0 ];
